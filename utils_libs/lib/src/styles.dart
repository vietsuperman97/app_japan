...
class AppStyle {
  ...
  static const DEFAULT_SMALL = TextStyle(
      fontFamily: 'NotoSansJP',fontSize: AppValue.FONT_SIZE_SMALL, color: COLORS.BLACK, height: 1.2);

  static const DEFAULT_SMALLs = TextStyle(
      fontFamily: 'NotoSansJP',fontSize: AppValue.FONT_SIZE_SMALLS, color: COLORS.BLACK, height: 1.2);

  static const DEFAULT_MEDIUM = TextStyle(
      fontFamily: 'NotoSansJP',fontSize: AppValue.FONT_SIZE_MEDIUM, color: COLORS.BLACK, height: 1.2);

  static const DEFAULT_LARGE = TextStyle(
      fontFamily: 'NotoSansJP',fontSize: AppValue.FONT_SIZE_LARGE, color: COLORS.BLACK, height: 1.2);

  static const DEFAULT_VERY_LARGE = TextStyle(
      fontFamily: 'NotoSansJP', fontSize: AppValue.FONT_SIZE_VERY_LARGE,
      color: COLORS.BLACK,
      height: 1.2);
